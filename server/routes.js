...
module.exports = function(app) {
  ...
  //
  //   if (media.inline) {
  //     return '<div class="image-container inline-block"><div style="padding-bottom:' + aspect + '%"><div class="image invisible" data-image-src="' + media.src + '"></div></div></div>';
  //   }
  //
  //   if (media.left) {
  ...
  app.get('/:pane?', function (req, res) {
    ...
    data.push({
      text    : '<p>...det finns ytterligare en skön lirar som aspirerar på titeln - the \'Main man\', min systerson. Jag kallar honom \'Main man\', kommer så för alltid göra om inte \'Main man\' själv har synpunkter på smeknamnet. Ni ser, jag har aldrig träffat någon som den här ståtlige 102 cm långe mannen.</p>',
      author  : 'consiglieri',
